    ...
    class MainExtractViewModel : ViewModelBase
    {
        ...
        private void backupThread()
        {
            ...
            if (File.Exists(backupEXE))
            {
                ...
                {
                    setProgress("数据备份中，请勿中途卸载设备...", null, 2);
                    ...
                    if (File.Exists(mbdbFile))
                    {
                        ...
                        progressVM.Title = "正在建立数据目录树，请稍候...";
                        addSystemLog("数据目录建立", "开始");

                        progressVM.Percent = 55;
        ...
        private void AnalysisProc()
        {
            ...
            //    string tempPath = Program.CaseDataPath;//+ "Case";//Application.StartupPath + "\\Case";
